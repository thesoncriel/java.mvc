$(function(){
    ...
    var vmCustRegReqList = new ViewModel( "#panel_custRegReqList", ["req_state"] );
    var vmCustRegReqAllow = new ViewModel( "#panel_custRegReqAllow", ["id_cust"] );
    var vmCustRegReqCancel = new ViewModel( "#panel_custRegReqCancel" );
